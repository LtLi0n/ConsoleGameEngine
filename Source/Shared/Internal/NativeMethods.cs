...
{
    ///<summary>A helper class for User32 Kernel32 dll winapi methods.</summary>
    static internal class NativeMethods
    {
        ...
        public struct ColorRef
        {
            ...
            internal ColorRef(PaletteColor color)
            {
